...
public final class RemoteDataSource: NSObject {
    ...
    public let baseAPI = "https://api.rawg.io/api"
    public let apiKey = "e07d0723795c4dfc8130cbcaf6083be6"
}
...
extension RemoteDataSource: RemoteDataSourceProtocol {
    ...
    public func getDetail(_ gameID: Int) -> AnyPublisher<DetailGameResponse, Error> {
